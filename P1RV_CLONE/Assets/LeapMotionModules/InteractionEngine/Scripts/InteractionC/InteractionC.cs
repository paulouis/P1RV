...
namespace Leap.Unity.Interaction.CApi
{
    ...
    public struct INTERACTION_COMPOUND_DESCRIPTION
    {
        ...
        public IntPtr pShapes;
        //LEAP_IE_SHAPE_DESCRIPTION**
    ...
    public class InteractionC
    {
        ...
        {
            return LeapIEGetVersion();
        }

        public static UInt32 GetExpectedVersion()
        {
            return (UInt32)Version.Current;
        }
