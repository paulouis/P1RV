...
//////////////////////////////// GESTION DES OFFSETS ENTRE MAINS ET OBJET MANIPULE//////////////////////////
            ...
            {
                OffsetRot = transform.rotation * Quaternion.Lerp(_pinchDetectorA.Rotation, _pinchDetectorB.Rotation, 0.5f);
        ...
        private void transformDoubleAnchor()
        {
            ...
            if (FeatureMScript.IsRotating)
            {
                ...
                Quaternion pp = Quaternion.Lerp(_pinchDetectorA.Rotation, _pinchDetectorB.Rotation, 0.5f) * OffsetRot;
                ////// On freeze la translation /////// 

                Vector3 u = pp * Vector3.up;

                // _anchor.LookAt(_pinchDetectorA.Position, u);
                transform.LookAt(_pinchDetectorA.Position, u);
            }
